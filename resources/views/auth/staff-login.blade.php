...
<div class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <form id="login-form" method="POST" action="{{ route('staff.login.submit') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password"
                           ...
                           name="password"
                           required
                           class="w-full border border-gray-300 rounded-xl px-4 py-2 pr-11 focus:ring-2 focus:ring-green-400 focus:outline-none">
            ...
            <button id="login-btn" type="submit"
                    class="w-full bg-green-600 text-white py-2.5 rounded-xl font-semibold hover:bg-green-700 transition flex items-center justify-center gap-2">
        ...
        <p class="mt-6 text-center">
            <a href="{{ url('/') }}" class="text-sm text-gray-500 hover:text-green-600 transition inline-flex items-center gap-1">
