                ...
                <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-white to-gray-50">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400">Manage patient appointments</p>
                        </div>
                    </div>
                    <span class="inline-flex items-center gap-1.5 bg-green-50 text-green-700 text-sm font-semibold px-3 py-1.5 rounded-full border border-green-200">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-100">
                                <th class="px-5 py-3.5 text-left text-xs font-bold text-green-800 uppercase tracking-wider">
                                ...
                                <tr class="{{ $rowBorder }} hover:bg-gray-50/80 transition-colors duration-150">
                                    ...
                                    <td class="px-5 py-4">
                                        <form method="POST"
                                            ...
                                            @method('PATCH')
                                            <select name="status"
                                                class="border border-gray-200 rounded-lg px-2.5 py-1.5 text-xs bg-gray-50 focus:ring-2 focus:ring-green-400 focus:border-green-400 focus:outline-none focus:bg-white transition">
                                            ...
                                            <button type="submit"
                                                class="inline-flex items-center gap-1 bg-green-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg hover:bg-green-700 hover:shadow-md transition-all duration-150">
                                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
