...
<div id="login-overlay" class="fixed inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm hidden transition-opacity duration-300">
    <div class="flex flex-col items-center space-y-4">
        <div class="relative w-12 h-12">
            ...
            <div class="absolute inset-0 rounded-full border-4 border-transparent border-t-slate-700 animate-spin"></div>
        </div>
...
<div class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <form id="login-form" method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password"
                           ...
                           name="password"
                           required
                           class="w-full border border-gray-300 rounded-xl px-4 py-2 pr-11 focus:ring-2 focus:ring-slate-400 focus:outline-none">
            ...
            <button id="login-btn" type="submit"
                    class="w-full bg-slate-700 text-white py-2.5 rounded-xl font-semibold hover:bg-slate-800 transition flex items-center justify-center gap-2">
        ...
        <p class="mt-3 text-center">
            <a href="{{ url('/') }}" class="text-sm text-gray-500 hover:text-slate-700 transition inline-flex items-center gap-1">
